...
with open("config.txt","r")as cfg:
    ...
    div=30/float(conf[3][conf[0].find("[")+1:conf[3].find("]")])
    corners=bool(conf[4][conf[0].find("[")+1:conf[4].find("]")])
